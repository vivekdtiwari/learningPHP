...
//Contains non-database related functions for the Coffee Page.
class CoffeeController
{
    function CoffeeDropdownList() {
        ...
        foreach ($coffeeArray as $key => $coffee) {
            $result = $result .
                    ...
                    <table class = 'coffeeTable'>
                        <tr>
                            <th rowspan='6' width='150px' ><img runat = 'server' src = '$coffee->image' alt='Coffee Image'></th>
                            <th>Name: </th>
                            <td>$coffee->Name</td>
                        </tr>
